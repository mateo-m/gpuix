...
pub struct RetainedElement {
    ...
    /// The declarations on this element, or `None` when it declares nothing.
    ///
    /// Boxed because `StyleDesc` is over 1,700 bytes and most elements in a
    /// tree declare nothing. Inline, every one of them carried the whole
    /// struct.
    pub style: Option<Box<StyleDesc>>,
    ...
    pub resolved: RefCell<Option<Arc<crate::style::resolve::Resolved>>>,
    ...
    pub descended: RefCell<Option<(crate::inheritance::Inherited, crate::inheritance::Inherited)>>,
}
...
impl RetainedElement {
    ...
    pub fn descend(&self, parent: &crate::inheritance::Inherited) -> crate::inheritance::Inherited {
...
impl RetainedTree {
    ...
    pub fn set_style(&mut self, id: u64, style: Box<StyleDesc>) {
